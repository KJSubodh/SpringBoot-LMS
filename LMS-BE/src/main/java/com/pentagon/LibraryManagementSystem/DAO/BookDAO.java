...
public class BookDAO {
	...
	public Book updateBook(int id, Book bookDetails) {
		...
		if (bookOpt.isPresent()) {
			...
			return book.save(existingBook); // This calls the Repository's save
		}
		return null;
	}
